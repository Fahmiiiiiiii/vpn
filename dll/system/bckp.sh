...
LLatest=`date`
Get_Data () {
git clone https://github.com/Fahmiiiiiiii/user-backup-db.git /root/user-backup/ &> /dev/null
}
...
Save_And_Exit () {
    ...
    git remote add origin https://github.com/Fahmiiiiiiii/user-backup-db
...
link="https://raw.githubusercontent.com/Fahmiiiiiiii/user-backup-db/main/$NameUser/$NameUser.zip"
sleep 1
