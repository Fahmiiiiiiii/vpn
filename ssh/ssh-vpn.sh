...
curl -sS https://raw.githubusercontent.com/Fahmiiiiiiii/vpn/main/ssh/password | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/pam.d/common-password
...
# install squid
cd
curl -sS "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn/main/ssh/squid3.conf" | openssl aes-256-cbc -d -a -pass pass:scvps07gg -pbkdf2 > /etc/squid/squid.conf
...
wget -q https://raw.githubusercontent.com/Fahmiiiiiiii/vpn/main/ssh/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/Fahmiiiiiiii/vpn/main/banner/issue.net"
