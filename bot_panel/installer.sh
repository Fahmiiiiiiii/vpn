...
surat=$(curl -sS https://raw.githubusercontent.com/Fahmiiiiiiii/access/main/bot | grep -w 139.162.32.40 | awk '{print $4}'  )
if [[ "$surat" = "true" ]]; then
echo -ne
else
...
dircreate
        ...
        echo -e "FahmiStore Bot Panel Installer
        "
        [[ ! -f /root/ResBotAuth ]] && {
        ...
        echo -ne "Username admin panel use '@' [Ex: @mailbintisukijem] : "
        read admin_pnl
        [[ -z $admin_pnl ]] && admin_pnl="@mailbintisukijem"
        echo ""
...
fun_instbot() {
    echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo -e "         ⚠️ PERHATIAN ⚠️"
    echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo -e " • Pergi Ke @BotFather Untuk Membuat Bot Type : /newbot"
    echo -e " • Pergi Ke @MissRose_bot Untuk Mengambil Id Type : /id"
    echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo -e "Note:
    
    y = Untuk Memulai Bot
    n = Untuk MengCancel Bot
    d = Hapus File Config Sebelumnya
    "
    echo -ne "Apakah Anda ingin melanjutkannya ? [y/n/d]: " 
    read resposta
    if [[ "$resposta" = 'd' ]]; then
    rm -f /etc/.maAsiss/bot.conf
    menu
