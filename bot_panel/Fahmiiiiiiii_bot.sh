...
local msg
msg="===========================\n"
msg+="Selamat Datang <b>${message_from_first_name[$id]}</b>\n\n"
msg+="Untuk Akses Menu [ /menu ]\n"
msg+="Untuk Melihat Info Server [ /info ]\n"
msg+="Untuk Free Account [ /free ]\n\n"
msg+="===========================\n"
[[ "${message_from_id[$id]}" != "$Admin_ID" ]] && {
msg+="<b>Acces Token:</b>\n"
msg+="<code>$fcm</code>\n"
...
[[ ! -f "/etc/.maAsiss/update-info" ]] && {
   ...
   local env_msg
   env_msg="━━━━━━━━━━━━━━━━━━━━━\n"
   env_msg+="🏷 Informasi Untuk Resseler :\n\n"
   env_msg+="$inf\n\n"
   env_msg+="━━━━━━━━━━━━━━━━━━━━━\n"
}
        ShellBot.editMessageText --chat_id ${callback_query_message_chat_id[$id]} \
